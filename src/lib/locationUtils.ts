...
export const METRO_MANILA_AREAS = [
  ...
  { name: "Pasay City", lat: 14.5378, lng: 120.9896 },
  { name: "Parañaque City", lat: 14.4793, lng: 121.0198 },
  { name: "Las Piñas City", lat: 14.4383, lng: 120.9794 },
  { name: "Muntinlupa City", lat: 14.3832, lng: 121.0409 },
  { name: "Marikina City", lat: 14.6507, lng: 121.1029 },
  { name: "Valenzuela City", lat: 14.7000, lng: 120.9822 },
  { name: "Caloocan City", lat: 14.6488, lng: 120.9668 },
  { name: "Malabon City", lat: 14.6648, lng: 120.9568 },
  { name: "Navotas City", lat: 14.6691, lng: 120.9467 }
]

// Search for area by name (case-insensitive)
export function searchMetroManilaArea(query: string) {
  const normalizedQuery = query.toLowerCase().trim()
  return METRO_MANILA_AREAS.filter(area =>
